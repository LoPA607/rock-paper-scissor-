...
socket.on('newGame2', () => {
    ...
    document.getElementById('opponentState').innerHTML = "Waiting for Opponent";

    // Enable choice buttons
    document.querySelectorAll('#player1Choice button').forEach(button => {
